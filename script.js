...
for (const neighbor in metroStations[currentStation]) {
  const distance = distances[currentStation] + metroStations[currentStation][neighbor];
...
document.getElementById('fare').textContent = 'Rs. '+fare; // You can replace 'units' with your currency
